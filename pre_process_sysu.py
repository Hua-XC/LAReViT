...
data_path = '/home/gml/HXC/dataset/SYSU-MM01/'
data_path_save='/home/gml/HXC/dataset/SYSU-MM01/'
...
id_train.extend(id_val) #id_val接在id_train的后面
...
np.save(data_path_save + 'train_rgb_resized_img.npy', train_img)
np.save(data_path_save + 'train_rgb_resized_label.npy', train_label)
...
np.save(data_path_save + 'train_ir_resized_img.npy', train_img)
np.save(data_path_save + 'train_ir_resized_label.npy', train_label)
print(data_path_save + 'train_ir_resized_label.npy')
