...
from channel_aug import ChannelT, ChannelAdapGray, ChannelRandomErasing,ChannelExchange,PCBRandomErasing,PCBChannelRandomErasing,ChannelRandomErasing
...
def train_transforms(H,W,normalize):
...
def train_transforms_color1(H,W,normalize):
    transform_train=transforms.Compose( [
            ...
            #PCBChannelRandomErasing(probability = 0.5),
