...
def displt(query_feature,query_label,gallery_feature,gallery_label):
    ...
    ax.hist(intra.detach().cpu().numpy(), b, histtype="stepfilled", alpha=0.6, color = '#D0C2E8', density=True, label='Intra-class',rwidth=0.9)
    ...
    ax.set_xlabel('c) LAReViT')
    ax.legend() 
    fig.savefig('/home/gml/HXC/images/disVIT/dis1.svg',dpi=1000,format='svg')
  
    plt.savefig('/home/gml/HXC/images/disVIT/dis3.svg',dpi=1000,format='svg')
